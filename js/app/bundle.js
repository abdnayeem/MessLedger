// Build of bundle.js (source: js/app/00..20-*.js, concatenated in numeric order).
// NOTE: this build is a plain concatenation, not minified (terser timed out in the
// build environment when this was last regenerated). Functionally identical to a
// minified build — just larger. Re-minify with terser -c -m if desired:
//   cat js/app/00-*.js js/app/01-*.js ... (in numeric order) | terser -c -m -o js/app/bundle.js
